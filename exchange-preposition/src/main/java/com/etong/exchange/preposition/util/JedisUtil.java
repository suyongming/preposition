...
public class JedisUtil {
    ...
    static {
        ...
        //redis未设置了密码：
        jedisPool = new JedisPool(config, "192.168.50.20",6379);
    }
    ...
    public class Keys {
         ...
         * @param  key String
         * @param  parame 定义排序类型或limit的起止位置. SortingParams
        ...
        /**
         * 查找所有匹配给定的模式的键
         * @param  pattern key的表达式,*表示多个，？表示一个 String
         * */
    ...
    public class Sets {
         ...
         * @param  newkey 新结果集的key String
         * @param keys 比较的集合 String ...
         * @return 新集合中的记录数
         * **/
